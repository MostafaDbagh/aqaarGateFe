...
export default function Properties({ listings, isLoading, isError, showHeading = true }) {
  ...
  const gridContent = (
      <div className="tf-layout-mobile-md md-col-2 lg-col-3 gap-15 propertiesGrid">
      ...
      <div className="box-house">
        <div className="image-wrap" style={{
          ...
          {(listing.isVip || listing.isFeatured) && (
            <span
              className={listing.isVip ? 'vip-crown-badge' : 'featured-star-badge'}
              style={{
                position: 'absolute',
                top: '10px',
                ...
                gap: '6px',
                ...(listing.isVip ? { padding: '6px 12px', width: 'auto', minHeight: '32px', borderRadius: '9999px' } : { width: '32px', height: '32px', borderRadius: '50%' }),
                backgroundColor: listing.isVip ? '#2c2e33' : 'rgba(0,0,0,0.35)',
                opacity: listing.isVip ? 0.85 : 1,
                color: listing.isVip ? '#f97316' : '#f0b429',
                fontSize: listing.isVip ? '13px' : undefined,
                fontWeight: listing.isVip ? 700 : undefined,
              }}
              title={listing.isVip ? (locale === 'ar' ? 'VIP' : 'VIP') : (locale === 'ar' ? 'مميز' : 'Featured')}
              aria-hidden="true"
            >
              {listing.isVip ? (
                <>
          ...
          >
            <img
              ...
              width={140}
              height={140}
              style={{ display: 'block', maxHeight: '140px', width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 1px 2px rgba(0,0,0,0.3))' }}
            />
          </span>
        ...
        <div className="content">
          ...
          <ul className="meta-list flex" style={{ gap: '24px' }}>
            ...
            <li className="text-1 flex items-center">
              ...
              <span>{listing.size ?? "N/A"}</span> {getSizeUnitLabel(listing.sizeUnit)}
            </li>
          </ul>
          ...
          <div className="contact-section" style={{ marginBottom: '16px' }}>
            <div className="wrap-btn flex">
              <div className="call-button-container" style={{ position: 'relative' }}>
                ...
                >
                  ...
                  {showPhoneNumbers[listing._id] ? formatPhoneNumber(getPropertyContactInfo(listing).phone) : t('common.call')}
                </button>
                ...
                {showPhoneNumbers[listing._id] && (
                  ...
                  >
                    <div style={{ display: 'flex', gap: '6px' }}>
                      <button
                        onClick={() => window.open(`tel:${getPropertyContactInfo(listing).phone}`)}
                        style={{
                          flex: 1,
                          background: '#10b981',
                          color: 'white',
                      ...
                      <button
                        onClick={() => handleWhatsAppClick(getPropertyContactInfo(listing).whatsapp)}
                        style={{
                          flex: 1,
                          background: '#25D366',
                          color: 'white',
            ...
            {getPropertyContactInfo(listing).facebook && (
              <div className={styles.followSection}>
                <div className={styles.followSectionContent}>
                  <button
                    className={styles.facebookButton}
                    onClick={() => window.open(getPropertyContactInfo(listing).facebook, '_blank', 'noopener,noreferrer')}
                  >
  ...
  if (!showHeading) return gridContent;
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="text-center" style={{ marginTop: '32px' }}>
              ...
              >
                {tHomeSections('viewAllProperties')}
