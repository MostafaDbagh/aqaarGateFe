...
export default async function Home({ params }) {
  ...
  return (
    <>
      ...
      <div className="seo-content" style={{ fontSize: '0.85rem', color: '#6b7280', padding: '1.5rem 1rem', maxWidth: '900px', margin: '0 auto', lineHeight: 1.5 }}>
        {locale === 'ar' ? (
          <>
            <h1>موقع عقاري - عقار جيت AqaarGate | افضل موقع عقارات في سوريا - سوق العقارات الإلكتروني في سورية</h1>
            <p>موقع عقاري وموقع عقارات - عقار جيت. افضل المواقع العقارية في سوريا. سوق العقارات الإلكتروني في سورية، منصة عقارات في سوريا - عدد العروض أكثر من 1000 عقار. شقق للبيع في سوريا، شقة للبيع في دمشق، عقارات في اللاذقية، شاليه في طرطوس، عقارات في حلب ودمشق وحمص. بيع وإيجار عقارات سوريا.</p>
            <h2>افضل موقع عقاري وموقع عقارات في سوريا</h2>
            <p>عقار جيت موقع عقاري وموقع عقارات من افضل المواقع العقارية في سوريا. أفضل موقع عقاري في سوريا للبيع والإيجار. عقارات للبيع في سوريا دمشق، أسعار الشقق في سوريا بالدولار، بيوت رخيصة للبيع في دمشق وريفها، شقق للبيع في سوريا بالتقسيط. عقارات سوريا حمص، عقارات دمشق بدون وسيط. سوق العقارات الإلكتروني في سورية - عدد العروض أكثر من 1000 عقار. عقارات في دمشق، عقارات في حلب، عقارات في اللاذقية، عقارات في حمص وطرطوس.</p>
